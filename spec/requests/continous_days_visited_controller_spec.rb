...
describe ::DiscourseContinousDaysVisited::ContinousDaysVisitedController do
    describe "shoud correcty handle when created some day" do
      let(:user) { Fabricate(:user) }

      it "admin can access" do
        ContinousDaysVisited.expects(:continous_days_visited).once
      ...
      it "staff cannot access" do
        ContinousDaysVisited.expects(:continous_days_visited).never
